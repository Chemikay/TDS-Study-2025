...
#Quite similar to prior year's data spread
...
### Question 1
We will use the following logarithmic model:
...
-   for Question 1, this is 2 ($X_{new}$ and $X_{pair}$) + 6 (# field programs -1)
###Perry looking into this with math for covariates wiht adding new variabel for which field program. 


##### remove these now that not going into Q2. 
...
## *because accounting for groups in the model, divide out between them rather than per group##
